...
<template>
    <div class="table-container">
            ...
            <tbody>
                <tr v-for="p in procedures" :key="p.id">
                    ...
                    <td>
                        ...
                        <button class="btn btn-danger" @click.prevent="handleDeleteClick(p.id)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <DeleteCard v-if="modals.deleteModal" v-model="modals.deleteModal" :id="modals.id" :type="'procedures'" />
    </div>
</template>